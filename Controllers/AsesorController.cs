    ...
    public class AsesorController : ControllerBase{
        ...
        public async Task<IActionResult> GetAll(){
            ...
            foreach(var entity in query){
                ...
                Especialidad esp = await _repositoryEsp.GetById(entity.ClaveEsp);
                Turno turno = await _repositoryTurno.GetById(entity.ClaveTurno);

                entity.ClaveUsuarioNavigation.Nombres = usuario.Nombres;
                entity.ClaveUsuarioNavigation.Apellidos = usuario.Apellidos;
                entity.ClaveTurnoNavigation.NombreTurno = turno.NombreTurno;
                entity.ClaveEspNavigation.NombreEsp = esp.NombreEsp;
        ...
        public async Task<IActionResult> GetById(int id){
            ...
            var usuario = await _repositoryUser.GetById(entity.ClaveUsuario);
            var esp = await _repositoryEsp.GetById(entity.ClaveEsp);
            var turno = await _repositoryTurno.GetById(entity.ClaveTurno);
