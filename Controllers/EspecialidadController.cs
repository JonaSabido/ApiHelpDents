...
namespace ApiHelpDents.Controller{
    ...
    public class EspecialidadController : ControllerBase{
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] EspecialidadCreateRequest especialidad){
            
            var entity = _mapper.Map<EspecialidadCreateRequest, Especialidad>(especialidad);
        ...
        public async Task<IActionResult> Delete(int id){
            ...
            if(id <= 0 || !_repository.Exist(i => i.IdEsp == id))
