...
namespace ApiHelpDents.Infraestructure.Repositories
{
    public class AdministradorRepository : IAdministradorRepository
    {
        ...
        public AdministradorRepository(HelpDentsBDContext context)
        {
        ...
        public async Task<Administrador> GetById(int id){
            ...
            var entity = await _context.Administradors.FirstOrDefaultAsync(x => x.IdAdmin == id);
            return entity;
        }
        ...
        public async Task<bool> Update(int id, Administrador admin){
            ...
            entity.Nombres = admin.Nombres;
            entity.Apellidos = admin.Apellidos;
